 ...
 *
 * Issue #65 experimental prototype. This file is the shared bootstrap for
...
// This whole directory is an experimental prototype (Issue #65); it is
...
// WordPress 0.71's config + database layer. b2config.php ends by
 ...
 *
 * Reuses 0.71's own cookie auth (the 'wordpressuser' / 'wordpresspass'
