...
//
//     Vite's import.meta.glob pulls every file under playground/wp/ into
...
//     playground/wp/ is produced by scripts/build-overlay.mjs: a fresh
...
//
//     Vite の import.meta.glob が playground/wp/ 配下の全ファイルを生の
//     バイト列として JavaScript バンドルへ取り込み、パスをキーにする。
//     ブラウザアプリは起動時に各エントリを php-wasm 仮想ファイルシステム
//     へ書き込む。playground/wp/ は scripts/build-overlay.mjs が生成する。
