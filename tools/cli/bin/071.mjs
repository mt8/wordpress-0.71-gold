...
/**
 * Locate a PHP binary. Honours the PHP environment variable, then probes
...
function locatePhp() {
	...
	// Fall back to a bare `php`; spawnSync reports ENOENT if it is missing.
	return 'php';
}
